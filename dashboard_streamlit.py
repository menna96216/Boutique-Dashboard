...
st.caption("Shows which sales channel generates the highest profit.")
...
st.caption("Shows which clothing style is most profitable on average.")
...
st.caption("Shows how profit is distributed across product types and customer segments.")
...
st.caption("Analyzes the relationship between advertising spend and profit.")
...
st.caption("Shows the monthly trend of average profit and margin.")
...
st.caption("Margin performance for each combination of product type and style.")
...
st.caption("Shows how margin varies by Style and Channel combination.")

# -----------------------------
# 14. Summary Table: Margin & Profit per Channel & Style
# -----------------------------
summary_table = dff.groupby(['channel','style'])[['profit','margin']].mean().reset_index()
st.subheader("Average Profit & Margin per Channel & Style")
st.dataframe(summary_table)

# -----------------------------
# 15. Top Performers Table
# -----------------------------
